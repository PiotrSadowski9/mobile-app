    ...
    return (
        <footer className={'bg-gray-300 text-center text-xs p-3 absolute bottom-0 w-full'}>
            ...
            <ul className={"flex justify-center my-3 "}>
                ...
                <li><img className={'h-5 px-4'} alt="Twitter logo" src={TTLogo}/></li>
                <li><img className={'h-5 px-4'} alt="Instagram logo" src={INLogo}/> </li>
                <li><img className={'h-5 px-4'} alt="YouTube logo" src={YTLogo}/></li>
            </ul>
